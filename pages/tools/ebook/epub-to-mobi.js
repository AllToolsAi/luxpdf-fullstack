...
export default function EpubToMobi() {
    ...
    const { getRootProps, getInputProps, isDragActive } = useDropzone({
        ...
        accept: {
            ...
            'application/octet-stream': ['.epub'] // added common fallback mime
        },
        maxFiles: 1,
        multiple: false,
    });

    const convertToMobi = useCallback(async () => {
        if (!file) return;
        setConverting(true);
        setResult(null);
        ...
        setResult({
            fileName: file.name.replace(/\.epub$/i, '.mobi'),
    ...
    return (
        <>
            <Head>
                <title>EPUB to MOBI Converter - Fast & Easy</title>
                <meta name="description" content="Convert your EPUB eBooks to MOBI format quickly and easily online." />
                <meta property="og:title" content="EPUB to MOBI Converter" />
                <meta property="og:description" content="Convert your EPUB eBooks to MOBI format quickly and easily online." />
